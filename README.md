if not LPH_OBFUSCATED then -- if obfuscated then just remove this
    getgenv().Gult = {
    ['Options'] = {
        ['Notifications'] = false, --// enables lock noti
        ['FOVMode'] = "Sticky" , --// Sticky and FollowMouse
        ['MuteBoomBox'] = true,  --// auto mutes boom boxes so u dont have too
        ['AutoLowGfx'] = false,  --// Puts lowgfx on so you dont have too
        ['RemoveSeats'] = false, --// Removes all seats from game :P
    },
    ['AimAssist'] = {
        ['Main'] = {
            ['Enabled'] = true,
    ...
    ["SilentAim"] = {
        ['Main'] = {
            ...
            ['AntiCurve'] = false,     --// Makes Silent not curve much
            ['AntiGroundShots'] = false, --// makes silent not hit the ground if u got bad sets
            ['ClosestPoint'] = false     --// goes to the closest point of ur mouse
    ...
    ['Visuals'] = {
        ...
        ['HealthBar'] = false,
        ['NameESP'] = false,
        ['Radar'] = true   --// creates a radar on the top right
    },
    ['Texture'] = {     --// creates in game dev packets to show texures
        ['Enabled'] = true,
        ['Material'] = "Brick",
        ['Color'] = Color3.fromRGB(255,255,255)
    },
    ['WaterMark'] = {  --// puts a watermark on the bottom left.
        ['Enabled'] = true,
        ['ShowFPS'] = true
    },
    ['PingPrediction'] = { -- *REWRITE* Put my HOL sets into here.
        ['Enabled'] = true,
        ['ping20_30'] = 0.12588,
        ['ping30_40'] = 0.11911,
        ['ping40_50'] = 0.12471,
